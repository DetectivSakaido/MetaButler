from metabutler.modules.sql.locales_sql import switch_to_locale, prev_locale
from metabutler.modules.tr_engine.strings import tld, LANGUAGES
from telegram.ext import CommandHandler
from telegram import ParseMode, InlineKeyboardMarkup, InlineKeyboardButton
from metabutler import dispatcher
from metabutler.modules.tr_engine.list_locale import list_locales
...
def locale_button(bot, update):
    ...
    lang_match = re.findall(r"en-US", query.data)
    if lang_match:
        if lang_match[0]:
